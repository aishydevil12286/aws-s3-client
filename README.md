...
<p>
	<b>Note</b>.  See <a href="http://docs.aws.amazon.com/AmazonS3/latest/dev/BucketRestrictions.html" target="_blank">Bucket Restrictions and Limitations</a>. See also <a href="http://acloudysky.com/build-aws-s3-client-application#createrunnablejar/" target="_blank">Create Runnable JAR</a>.
</p>
